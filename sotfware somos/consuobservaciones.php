...
<title>SOMOS - Consulta Observaciones</title>
	<script type="text/javascript">
var xajaxRequestUri="http://www.movimientodelpueblo.com/somosmp/consuobservaciones.php";
...
function xajax_cambioRE(){return xajax.call("cambioRE", arguments, 1);}
...
function xajax_mesas(){return xajax.call("mesas", arguments, 1);}
...
<script language="javascript">
	...
	function mostrar(id)
	{
		switch (id)
		{
			...
			<tr><td><label><input type="checkbox" name="busqueda7" id="busqueda7" onclick="mostrar2(7);" />Por Tipo Observacion</label></td>\
				<td><label><input type="checkbox" name="busqueda8" id="busqueda8" onclick="mostrar2(8);" />Por Barrio</label></td></tr>\
			<tr><td><label><input type="checkbox" name="busqueda12" id="busqueda12" onclick="mostrar2(12);" />Persona que Digita </label></td>\
				<td><label><input type="checkbox" name="busqueda13" id="busqueda13" onclick="mostrar2(13);" />Fecha Digitacion</label></td></tr>\
			<tr><td><label><input type="checkbox" name="busqueda18" id="busqueda18" onclick="mostrar2(18);" />Por Sitio de Votación</label></td>\
				<td><label><input type="checkbox" name="busqueda19" id="busqueda19" onclick="mostrar2(19);" />Por Mesa de Votación</label></td></tr>\
			...
			break;
			case 18:
			document.getElementById('consult').innerHTML='<label>Seleccione el Pais, el Departamento, Municipio y Puesto de Votación</label><br><select name="patron3" id="patron3" class="sperfil2" onchange="xajax_departamento(this.value,'+"'patron2'"+')"></select><select name="patron2" id="patron2" class="sperfil2" onchange="xajax_municipio(this.value,'+"'patron1'"+')" style="visibility:hidden"></select><select name="patron1" id="patron1" class="sperfil2" onchange="xajax_puestos(this.value,'+"'patron'"+')" style="visibility:hidden"></select><select name="patron" id="patron" class="sperfil2" style="visibility:hidden"></select>';
			xajax_llenar2(3);
			break;
			case 19:
			document.getElementById('consult').innerHTML='<label>Seleccione el Pais, el Departamento, Municipio y Puesto y la Mesa de Votación</label><br><select name="patron4" id="patron4" class="sperfil2" onchange="xajax_departamento(this.value,'+"'patron3'"+')"></select><select name="patron3" id="patron3" class="sperfil2" onchange="xajax_municipio(this.value,'+"'patron2'"+')" style="visibility:hidden"></select><select name="patron2" id="patron2" class="sperfil2" onchange="xajax_puestos(this.value,'+"'patron1'"+')" style="visibility:hidden"></select><select name="patron1" id="patron1" class="sperfil2" onchange="xajax_mesas(this.value,'+"'patron'"+')" style="visibility:hidden"></select><select name="patron" id="patron" class="sperfil2" style="visibility:hidden"></select>';
			xajax_llenar2(4);
			break;
		}
	}
	function mostrar2(id)
	{
		...
		case 7:
			...
			hijo2.innerHTML="Tipo Observacion: ";
			hijo2.appendChild(hijo);
		...
		case 8:
			var hijo=document.createElement('select');
			hijo.setAttribute('name', 'patron8');
			hijo.setAttribute('id', 'patron8');
			hijo.setAttribute('class', 'sperfil2');
			var hijo2=document.createElement('div');
			hijo2.setAttribute('id', 'divpatron8');
			hijo2.innerHTML="Barrio: ";
			hijo2.appendChild(hijo);
			if(document.getElementById('busqueda8').checked)
			{
				document.getElementById('consult2').appendChild(hijo2);
				xajax_llenar(11);
			}
			...
			{
				var quitar=document.getElementById('divpatron8');
				document.getElementById('consult2').removeChild(quitar);
			}
		break;
		case 12:
			...
			hijo2.innerHTML="Persona que Actualiza: ";
			hijo2.appendChild(hijo);
		...
		case 18:
			/*var hijo=document.createElement('select');
			hijo.setAttribute('name', 'patron18');
			hijo.setAttribute('id', 'patron18');
			hijo.setAttribute('class', 'sperfil');*/
			var hijo2=document.createElement('div');
			hijo2.setAttribute('id', 'divpatron18');
			hijo2.innerHTML='<label>Seleccione el Pais, el Departamento, Municipio y Puesto de Votación</label><br><select name="patron183" id="patron183" class="sperfil2" onchange="xajax_departamento(this.value,'+"'patron182'"+')"></select><select name="patron182" id="patron182" class="sperfil2" onchange="xajax_municipio(this.value,'+"'patron181'"+')" style="visibility:hidden"></select><select name="patron181" id="patron181" class="sperfil2" onchange="xajax_puestos(this.value,'+"'patron18'"+')" style="visibility:hidden"></select><select name="patron18" id="patron18" class="sperfil2" style="visibility:hidden"></select>';
			//hijo2.appendChild(hijo);
			if(document.getElementById('busqueda18').checked)
			{
				document.getElementById('consult2').appendChild(hijo2);
				xajax_llenar(18);
			}
			...
			{
				var quitar=document.getElementById('divpatron18');
				document.getElementById('consult2').removeChild(quitar);
			}
		break;
		case 19:
			var hijo=document.createElement('select');
			hijo.setAttribute('name', 'patron19');
			hijo.setAttribute('id', 'patron19');
			hijo.setAttribute('class', 'sperfil2');
			var hijo2=document.createElement('div');
			hijo2.setAttribute('id', 'divpatron19');
			hijo2.innerHTML='<label>Seleccione el Pais, el Departamento, Municipio y Puesto y la Mesa de Votación</label><br><select name="patron194" id="patron194" class="sperfil2" onchange="xajax_departamento(this.value,'+"'patron193'"+')"></select><select name="patron193" id="patron193" class="sperfil2" onchange="xajax_municipio(this.value,'+"'patron192'"+')" style="visibility:hidden"></select><select name="patron192" id="patron192" class="sperfil2" onchange="xajax_puestos(this.value,'+"'patron191'"+')" style="visibility:hidden"></select><select name="patron191" id="patron191" class="sperfil2" onchange="xajax_mesas(this.value,'+"'patron19'"+')" style="visibility:hidden"></select><select name="patron19" id="patron19" class="sperfil2" style="visibility:hidden"></select>';
			//hijo2.appendChild(hijo);
			if(document.getElementById('busqueda19').checked)
			{
				document.getElementById('consult2').appendChild(hijo2);
				xajax_llenar(19);
			}
			...
			{
				var quitar=document.getElementById('divpatron19');
				document.getElementById('consult2').removeChild(quitar);
			}
		break;
		}
	...
	function cargar(id,valor)
	{
		...
		if(id=='11')
		{
			if (document.getElementById('patron8').innerHTML=="")
			{
				document.getElementById('patron8').innerHTML=valor;
			}
		}
		if(id=='12')
		{
		...
		if(id=='18')
		{
			if (document.getElementById('patron18').innerHTML=="")
			{
				document.getElementById('patron18').innerHTML=valor;
			}
		}
		if(id=='19')
		{
			if (document.getElementById('patron19').innerHTML=="")
			{
				document.getElementById('patron19').innerHTML=valor;
			}
		}
	}
function ocultar()
...
<div id="bi"></div>
<br>
<div class="icono"><h1>Consultar Observaciones</h1></div>
