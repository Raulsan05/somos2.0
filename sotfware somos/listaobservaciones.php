...
<title>SOMOS - Listado Observaciones</title>
	<script type="text/javascript">
var xajaxRequestUri="http://www.movimientodelpueblo.com/somosmp/listaobservaciones.php";
...
<div id="bi"></div>
<br>
<div class="icono"><h1>Listado Observaciones</h1></div>
<div id="mensaje">Seleccione el patron de busqueda.</div><br>
<form class="editars" id="formulario" action="listadoobservaciones.php"  method="post" target="_blank">
</form>
<br>
<br>
<div id="nucleof">
