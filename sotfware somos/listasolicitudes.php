...
<title>SOMOS - Consulta Solicitudes</title>
	<script type="text/javascript">
var xajaxRequestUri="http://www.movimientodelpueblo.com/somosmp/listasolicitudes.php";
...
<script language="javascript">
	...
	function mostrar(id)
	{
		switch (id)
		{
			...
			<tr><td><label><input type="checkbox" name="busqueda7" id="busqueda7" onclick="mostrar2(7);" />Por Tipo Solicitud</label></td>\
	...
	function mostrar2(id)
	{
		...
		case 7:
			...
			hijo2.innerHTML="Tipo Solicitud: ";
			hijo2.appendChild(hijo);
...
<div id="bi"></div>
<br>
<div class="icono"><h1>Listado Solicitudes</h1></div>
<div id="mensaje">Seleccione el patron de busqueda.</div><br>
<form class="editars" id="formulario" action="listadosolicitudes.php"  method="post" target="_blank">
</form>
<br>
<br>
<div id="nucleof">
