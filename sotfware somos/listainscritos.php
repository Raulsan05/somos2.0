...
<title>SOMOS - Listado Inscritos</title>
	<script type="text/javascript">
var xajaxRequestUri="http://www.movimientodelpueblo.com/somosmp/listainscritos.php";
...
<script language="javascript">
	...
	function mostrar(id)
	{
		switch (id)
		{
			...
			break;
			case 12:
			document.getElementById('consult').innerHTML='<label><input type="checkbox" name="subrefer" checked="checked"/>Mostrar Sub-Referidos</label><br><select name="patron" id="patron" class="sperfil2"></select>';
			xajax_llenar(12);
			break;
			case 13:
			document.getElementById('consult').innerHTML='<select name="patron" id="patron" class="sperfil2"></select>';
	...
	function mostrar2(id)
	{
		...
		case 12:
			...
			hijo2.innerHTML="Rol Estrategico: <br><label><input type='checkbox' name='subrefer' checked='checked'/>Mostrar Sub-Referidos</label><br>";
			hijo2.appendChild(hijo);
...
<div id="bi"></div>
<br>
<div class="icono"><h1>Listados Inscritos</h1></div>
<div id="mensaje">Seleccione el patron de busqueda.</div><br>
<form class="editars" id="formulario" action="listadoinscritos.php"  method="post" target="_blank">
</form>
<br>
<br>
<div id="nucleof">
