...
<title>SOMOS - Listado Fiesta</title>
	<script type="text/javascript">
var xajaxRequestUri="http://www.movimientodelpueblo.com/somosmp/listainscritosfiesta.php";
...
<div id="bi"></div>
<br>
<div class="icono"><h1>Listados Fiesta</h1></div>
<div id="mensaje">Seleccione el patron de busqueda.</div><br>
<form class="editars" id="formulario" action="listadoinscritosfiesta.php"  method="post" target="_blank">
</form>
<br>
<br>
<div id="nucleof">
