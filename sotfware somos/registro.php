...
<title>SOMOS - REGISTRAR USUARIO</title>
	<script type="text/javascript">
var xajaxRequestUri="http://www.movimientodelpueblo.com/somosmp/registro.php";
...
<div id="bi"></div>
<br>
<div class="icono"><h1>Registrar Usuario</h1></div>
<div id="mensaje">Ingrese los datos del nuevo usuario.<br>Los campos con (<a style='color:red;font-weight:bold;'>*</a>) son abligatorios</div><br>
<form class="registro" id="formulario">
<table class="tregis">
<tr><td><label>Usuario (Max. 12 Caracteres)<a style='color:red;font-size:10px;font-weight:bold;'>*</a></label></td>
<td><input type="text" name="usuario"/></td></tr>
<tr><td><label>Contraseña<a style='color:red;font-size:10px;font-weight:bold;'>*</a></label></td>
<td><input type="password" name="contrasena"/></td></tr>
<tr><td><label>Confirmar contraseña<a style='color:red;font-size:10px;font-weight:bold;'>*</a></label></td>
<td><input type="password" name="confirmar"/></td></tr>
<tr><td><label>Perfil<a style='color:red;font-size:10px;font-weight:bold;'>*</a></label></td>
<td><select id="perfil"name="perfil" class="sperfil"> </select></td></tr>
<tr><td><label>Cargo<a style='color:red;font-size:10px;font-weight:bold;'>*</a></label></td>
<td><input type="text" name="cargo"/></td></tr>
<tr><td><label>Primer Nombre<a style='color:red;font-size:10px;font-weight:bold;'>*</a></label></td>
<td><input type="text" name="pnombre"/></td></tr>
<tr><td><label>Segundo Nombre</label></td>
<td><input type="text" name="snombre"/></td></tr>
<tr><td><label>Primer Apellido<a style='color:red;font-size:10px;font-weight:bold;'>*</a></label></td>
<td><input type="text" name="papellido"/></td></tr>
<tr><td><label>Segundo Apellido<a style='color:red;font-size:10px;font-weight:bold;'>*</a></label></td>
<td><input type="text" name="sapellido"/></td></tr>
<tr><td><label>Telefono<a style='color:red;font-size:10px;font-weight:bold;'>*</a></label></td>
<td><input type="text" name="telefono"/></td></tr>
<tr><td><label>Direccion<a style='color:red;font-size:10px;font-weight:bold;'>*</a></label></td>
<td><input type="text" name="direccion"/></td></tr>
<tr><td><label>Email<a style='color:red;font-size:10px;font-weight:bold;'>*</a></label></td>
<td><input type="text" name="email"/></td></tr>
</table>
<br>
<br>
<input class="btn" type="button" value="Registrar Usuario" onclick="xajax_ingresar(xajax.getFormValues('formulario'))"/>
</form>
</div>
<div class="piedpag">
</div>
