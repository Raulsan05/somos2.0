...
<title>SOMOS - INFOGRAMAS</title>
	<script type="text/javascript">
var xajaxRequestUri="http://www.movimientodelpueblo.com/somosmp/infogramas.php";
...
function xajax_guardar(){return xajax.call("guardar", arguments, 1);}
...
function xajax_temas(){return xajax.call("temas", arguments, 1);}
function xajax_imprimir(){return xajax.call("imprimir", arguments, 1);}
...
<script language="JavaScript">
	...
	function subiranex(info)
	{
		document.getElementById('anexos').innerHTML='<tr><td><iframe src="archinfo.php?infograma='+info+'"></iframe></td></tr><tr><td><input type="button" id="archi" class="btn2" style="margin:0px;" value="Finalizar Subida" onclick="xajax_archivos('+info+");"+'"></td></tr>';
	}
	function archiocu(info)
	{
		document.getElementById('anexos').innerHTML='<tr><td><input type="button" id="archi" class="btn2" style="margin:0px;" value="Ver Archivos Anexos" onclick="xajax_archivos('+info+");"+'"></td></tr>';
	}
</script>
</head>
<body>
...
<div id="bi"></div>
<br>
<div class="icono"><h1>Infograma Programatico</h1></div>
<div id="mensaje"></div><br>
<form class="editaru" id="formulario"method="post" action="">
</form>
<form id="formulario2"method="post" target="_blank" action="impreinfograma.php">
<input type="hidden" id="idinfograma2" name="idinfograma2">
</form>
</div>
<div class="piedpag">
</div>
