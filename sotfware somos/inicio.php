...
<title>SOMOS - INICIO</title>
	<script type="text/javascript">
var xajaxRequestUri="http://www.movimientodelpueblo.com/somosmp/inicio.php";
...
<div id="bi"></div>
<br>
<div class="icono"><h1>Bienvenido Al Sistema<br>SOMOS</h1></div>
<div id="mensaje">Seleccione la opcion que desea del menu.</div><br>
<form class="editaru" id="formulario"method="post" action="">
<div id="mensaje2"></div>
<div id="mensaje3"></div>
<div id="dtabla">
<table id="tabla" class="tinicio">
<tr><th colspan="2">Recomendaciones:</th></tr>
<tr><th></th><td> <br></td></tr>
<tr><th>*</th><td>Recuerde cerrar sesion cuando termine su trabajo</td></tr>
<tr><th>*</th><td>Los numeros de cedula no deben incluir puntos ni comillas(.')</td></tr>
<tr><th>*</th><td>Las fechas deben ir en formato (aaaa-mm-dd) (2000-01-31)</td></tr>
<tr><th>*</th><td>Los campos con (<a style="color:red;font-weight:bold;">*</a>) no pueden estar en blanco, son obligatorios</td></tr></table>
</div>
<div id="mensaje4"></div>
<br>
</form>
