...
<title>SOMOS - EDITAR USUARIO</title>
	<script type="text/javascript">
var xajaxRequestUri="http://www.movimientodelpueblo.com/somosmp/editar.php";
...
function xajax_listar3(){return xajax.call("listar3", arguments, 1);}
function xajax_listar4(){return xajax.call("listar4", arguments, 1);}
function xajax_listarp(){return xajax.call("listarp", arguments, 1);}
function xajax_modificar(){return xajax.call("modificar", arguments, 1);}
function xajax_modificar2(){return xajax.call("modificar2", arguments, 1);}
...
<div id="bi"></div>
<br>
<div class="icono"><h1>Editar Usuario</h1></div>
<div id="mensaje">Seleccione el usuario.</div><br>
<form class="editaru" id="formulario">
