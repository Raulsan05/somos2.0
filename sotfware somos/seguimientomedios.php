...
<title>SOMOS - SEGUIMIENTO DE MEDIOS</title>
	<script type="text/javascript">
var xajaxRequestUri="http://www.movimientodelpueblo.com/somosmp/seguimientomedios.php";
...
<script language="JavaScript">
	...
	{
		document.getElementById('anexos').innerHTML='<tr><td><iframe src="archseguimiento.html"></iframe></td></tr><tr><td><input type="button" id="archi" class="btn2" style="margin:0px;" value="Finalizar Subida" onclick="xajax_archivos('+info+");"+'"></td></tr>';
	}
...
<div id="bi"></div>
<br>
<div class="icono"><h1>Seguimiento de Medios</h1></div>
