...
<title>SOMOS - PERFILES USUARIOS</title>
	<script type="text/javascript">
var xajaxRequestUri="http://www.movimientodelpueblo.com/somosmp/perfiles.php";
...
function xajax_editar(){return xajax.call("editar", arguments, 1);}
...
<div id="bi"></div>
<br>
<div class="icono"><h1> Perfiles del Sistema </h1></div>
<br>
<form class="editars editarsam" id="formulario">
<div id="mensaje">NOTA:(0: no se permite acceso al modulo correspondiente,<br>1: se permite acceso al modulo correspondiente)</div>
<br>
<table id="tabla" class="tperfil" border="2">
</table>
<div id="mensaje3"></div>
<div id="mensaje2"></div>
<br>
<table border="0" class="tregis3" align="center">
<tr><th colspan="3">Modulos</th></tr>
<tr><td>Mod1:Registrar usuarios del sistema</td><td>Mod2:Resetear contraseñas</td><td>Mod3:Editar usuarios del sistema</td></tr>
<tr><td>Mod4:Personas</td><td>Mod5:Personajes</td><td>Mod6:Consulta Personas</td></tr>
<tr><td>Mod7:Consulta Solicitudes</td><td>Mod8:Consulta Observaciones</td><td>Mod9:Parametros del Sistema</td></tr>
<tr><td>Mod10:Listado Personas</td><td>Mod11:Listado Solicitudes</td><td>Mod12:Listado Observaciones</td></tr>
<tr><td>Mod13:Infograma Programatico</td><td>Mod14: Formulario de Votacion</td></tr>
</table>
<br>
</form>
</div>
